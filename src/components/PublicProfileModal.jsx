  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center p-6 sm:p-12 overflow- pointer-events-auto">
      ...
      >
          ...
          return (
            ...
            >
              <div className="w-full relative overflow-hidden px-2">
                ...
                <div className="w-full h-2.5 bg-mono-100 dark:bg-slate-950 rounded-md overflow-hidden relative z-10 shadow-inner border border-mono-200 dark:border-white/5">
                  <Motion.div
                    initial={{ width: 0 }}
                    ...
                    return (
                      <div key={m.id} className="relative">
                        <button
                          ...
                          className={`w-11 h-11 rounded-md border flex flex-col items-center justify-center transition-all duration-500 overflow- relative shadow-sm
        ...
        <div className="w-full space-y-3 mt-auto flex flex-col pt-4 border-t border-mono-200 dark:border-white/5">
           {isMe ? (
              ...
              <div className="w-full flex flex-col gap-3">
                <button 
                  ...
                  className="w-full py-3.5 rounded-md bg-mono-900 dark:bg-slate-100 text-mono-50 dark:text-slate-950 font-black text-base hover:opacity-90 active:scale-95 transition-all flex items-center justify-center gap-2 font-rabar border border-white/10 shadow-lg"
                >
              ...
              <div className="w-full flex flex-col gap-2">
                <div className="w-full py-3.5 rounded-md bg-mono-100 dark:bg-slate-800/50 border border-mono-200 dark:border-white/5 text-mono-400 dark:text-slate-400 font-bold text-xs text-center flex items-center justify-center gap-2 opacity-70">
              ...
              <div className="flex gap-2 w-full">
                <button onClick={handleAcceptFriendRequest} className="flex-2 py-3.5 rounded-md bg-emerald-500 text-slate-950 font-black text-sm hover:bg-emerald-400 active:scale-95 transition-all flex items-center justify-center gap-2 font-rabar shadow-md">
                  <span className="material-symbols-outlined text-lg">check_circle</span>
                  وەربگرە
                </button>
                <button onClick={handleDeclineFriendRequest} className="flex-1 py-3.5 rounded-md bg-red-500/10 border border-red-500/30 text-red-500 font-black text-sm hover:bg-red-500/20 active:scale-95 transition-all flex items-center justify-center gap-2">
