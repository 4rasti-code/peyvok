...
const PrivacyPolicy = ({ onViewChange, onClose }) => {
    ...
    const content = {
        ...
        ku: {
            ...
            intro: "ئەم ل پەیڤۆک ھەمی پێکۆلەکێ ددەین بۆ پاراستنا تایبەتمەندیا تە. ئەڤ ڕێبازە دیار دکەت کا ئەم چەوا پێزانینێن تە یێن کەسی بکار دهینین دەما تو یارییا مە بکار دهینی.",
            sections: [
                {
                    ...
                    list: [
                        ...
                        "داتایێن یاریێ (نمرەکان، ئاست، و پاداشتێن خەیالی) بۆ پاراستنا ڕێزا تە د لیستا سەرکەفتیاندا.",
                        "پێزانینێن ئامیرەیی (زمان، جۆرێ مۆبایلێ)."
                    ]
                },
                {
                    title: "٢. چەوا ئەم داتایێن فەیسبووکی بکار دهینین",
                    text: "ھەکە تە ھەلبژارت ب ڕێیا فەیسبووکی بچی د ژۆردا، ئەم ب تنێ دەستەکا مە ل سەر وان پێزانینان ھەیە کو تە ڕێپێدان پێ دایە. ئەم ڤان داتایان بکار دهینین بۆ:",
                    list: [
                        "دروستکرنا پڕۆفایلێ تە یێ تایبەت د ناڤ یاریێدا.",
                        "پیشاندانا ناڤ و وەلاتی تە د لیستا جیھانی یا سەرکەفتیاندا.",
                ...
                },
                {
                    ...
                    text: "مافێ تە ھەیە ل ھەر دەمەکی پێزانینێن خۆ ببینی، دەستکاری بکەی، یان ژی ببەی. تایبەت بۆ بکارھێنەرێن فەیسبووکی:",
                    list: [
