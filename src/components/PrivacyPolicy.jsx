        ...
        ku: {
            ...
            sections: [
                ...
                },
                {
                    ...
                    text: "مافێ تە ھەیە ل ھەر دەمەکی پێزانینێن خوە ببینی، دەستکاری بکەی، یان ژی ببەی. تایبەت بۆ بکارھێنەرێن فەیسبووکی:",
                    list: [
                        "بۆ ژێبرنا چالاکیێن یاریێ، ھەرە د ناڤ پڕۆفایلێ خوە یێ فەیسبووکی > Settings & Privacy > Settings > Apps and Websites.",
