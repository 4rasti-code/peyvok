...
const PrivacyPolicy = ({ onViewChange, onClose }) => {
    ...
    const content = {
        ...
        ku: {
            ...
            intro: "ئەم ل پەیڤۆک ھەمی پێکۆلەکێ ددەین بۆ پاراستنا تایبەتمەندیا تە. ئەڤ ڕێبازە دیار دکەت کا ئەم چەوا پێزانینێن تە یێن کەسی بکار دئینین دەما تو یارییا مە بەکار دھینی.",
            sections: [
                {
