...
export default function ShopView({ onPurchase, onPurchaseAvatar, equippedAvatar = 'default', ownedNameStyles = ['default'], equippedNameStyle = 'default', onPurchaseNameStyle, onEquipNameStyle, ownedFonts = ['default'], equippedFont = 'default', onPurchaseFont, onEquipFont, ownedBundles = ['default'], equippedBundle = 'default', onPurchaseBundle, onEquipBundle }) {
 ...
 <div className="flex flex-col sm:flex-row justify-between items-center bg-black/40 p-3 px-4 w-full relative z-10 gap-3 border-t border-white/10">
