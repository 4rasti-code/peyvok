...
const PodiumStep = ({ player, rank, delay, onPlayerClick }) => {
 ...
 return (
 <div className={`${size === 'lg' ? 'w-16 h-16' : 'w-11 h-11'} rounded-2xl bg-white/5 border-2 ${isFirst ? 'border-[#d9a441] gold-glow' : isSecond ? 'border-white/30' : 'border-orange-500/30'} flex items-center justify-center overflow- shadow-2xl z-10 relative `}>
 <Avatar 
 ...
 <div className={`w-full ${style.height} ${style.bg} rounded-t-[40px] border-t border-x ${style.border} flex flex-col items-center pt-5 relative overflow- shadow-2xl`}>
