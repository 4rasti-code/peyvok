            ...
            sections: [
                ...
                },
                {
                    ...
                    list: [
                        ...
                        "ئەگەر تە ھەست ب ھەر فێلبازیەکێ کر د ئەکاونتێ خۆ دا، زوو مە ئاگەھدار بکە."
                    ]
                },
                {
                ...
                },
                {
                    ...
                    text: "ھەمی جۆرێن دراڤی یان خالان یێن کو د ناڤ یاریێ دا دھێنە دان (وەکی فلس، دەرهەم، دینار) ب تنێ بۆ مەبەستا دەربازکرنا دەمی نە د ناڤ یاریێ دا و چو بھایەکێ ڕاستەقینە یێ ماددی نینە و نابیت ب پارێ ڕاستەقینە بھێنە فرۆشتن یان ئاڵوگۆڕکرن."
                }
            ]
        }
    };
