...
/**
 * 🎨 Dynamic Level Tiers & Colors
 * Changes every 5 levels up to 100, then stays Diamond Legendary.
 */
export const getLevelTier = (lvl) => {
  const tiers = [
     { name: 'Bronze', stop1: '#cd7f32', stop2: '#f97316', shadow: 'rgba(249, 115, 22, 0.4)' },    // 1-5
     { name: 'Silver', stop1: '#cbd5e1', stop2: '#94a3b8', shadow: 'rgba(148, 163, 184, 0.4)' },   // 6-10
     { name: 'Gold', stop1: '#fbbf24', stop2: '#d97706', shadow: 'rgba(245, 158, 11, 0.4)' },     // 11-15
     { name: 'Emerald', stop1: '#10b981', stop2: '#059669', shadow: 'rgba(16, 185, 129, 0.4)' },  // 16-20
     { name: 'Cyan', stop1: '#22d3ee', stop2: '#0891b2', shadow: 'rgba(6, 182, 212, 0.4)' },     // 21-25
     { name: 'Blue', stop1: '#3b82f6', stop2: '#2563eb', shadow: 'rgba(59, 130, 246, 0.4)' },     // 26-30
     { name: 'Indigo', stop1: '#6366f1', stop2: '#4f46e5', shadow: 'rgba(99, 102, 241, 0.4)' },   // 31-35
     { name: 'Purple', stop1: '#a855f7', stop2: '#7c3aed', shadow: 'rgba(168, 85, 247, 0.4)' },   // 36-40
     { name: 'Fuchsia', stop1: '#d946ef', stop2: '#c026d3', shadow: 'rgba(217, 70, 239, 0.4)' },  // 41-45
     { name: 'Pink', stop1: '#ec4899', stop2: '#db2777', shadow: 'rgba(236, 72, 153, 0.4)' },     // 46-50
     { name: 'Rose', stop1: '#f43f5e', stop2: '#e11d48', shadow: 'rgba(244, 63, 94, 0.4)' },     // 51-55
     { name: 'Red', stop1: '#ef4444', stop2: '#b91c1c', shadow: 'rgba(239, 68, 68, 0.4)' },      // 56-60
     { name: 'Orange', stop1: '#f97316', stop2: '#ea580c', shadow: 'rgba(249, 115, 22, 0.4)' },   // 61-65
     { name: 'Amber', stop1: '#f59e0b', stop2: '#d97706', shadow: 'rgba(245, 158, 11, 0.4)' },    // 66-70
     { name: 'Lime', stop1: '#84cc16', stop2: '#65a30d', shadow: 'rgba(132, 204, 22, 0.4)' },     // 71-75
     { name: 'Teal', stop1: '#14b8a6', stop2: '#0d9488', shadow: 'rgba(20, 184, 166, 0.4)' },     // 76-80
     { name: 'Sky', stop1: '#0ea5e9', stop2: '#0284c7', shadow: 'rgba(14, 165, 233, 0.4)' },      // 81-85
     { name: 'Violet', stop1: '#8b5cf6', stop2: '#7c3aed', shadow: 'rgba(139, 92, 246, 0.4)' },   // 86-90
     { name: 'Slate', stop1: '#64748b', stop2: '#334155', shadow: 'rgba(100, 116, 139, 0.4)' },   // 91-95
     { name: 'Midnight', stop1: '#1e293b', stop2: '#0f172a', shadow: 'rgba(30, 41, 59, 0.4)' },    // 96-100
     { name: 'Diamond', stop1: '#e2e8f0', stop2: '#94a3b8', shadow: 'rgba(148, 163, 184, 0.6)', isLegendary: true } // 100+
  ];
  
  if (lvl >= 100) return tiers[20];
  const tierIndex = Math.floor((lvl - 1) / 5);
  return tiers[Math.min(tierIndex, 19)];
};
